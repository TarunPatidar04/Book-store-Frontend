...
const API_URLS = {
  ...
  GET_PRODUCTS_BY_SELLER_ID: (sellerId: string) =>
    `${BASE_URL}/product/seller/${sellerId}`,
  DELETE_PRODUCTS_BY_PRODUCT_ID: (productId: string) =>
...
export const api = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getProductsBySelletId: builder.query({
      query: (sellerId) => API_URLS.GET_PRODUCTS_BY_SELLER_ID(sellerId),
      providesTags: ["Product"],
    }),
