          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 flex gap-2">
                ...
                >
                  <Heart
                    className={`h-4 w-4 mr-1 cursor-pointer ${wishlist.some((wishlistItem) => wishlistItem.products.includes(item.product._id)) ? "fill-red-500" : ""}`}
                  />
                  <span className="hidden md:inline cursor-pointer">
                    {wishlist.some((wishlistItem) =>
                      wishlistItem.products.includes(item.product._id),
                    )
